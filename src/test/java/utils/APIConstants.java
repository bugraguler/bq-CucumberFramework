...
public class APIConstants {
    ...
    public static final String CRATE_EMPLOYEE_URI = BaseURI + "/createEmployee.php";
    ...
    public static final String UPDATE_EMPLOYEE_STATUS_URI = BaseURI + "/employeementStatus.php";
